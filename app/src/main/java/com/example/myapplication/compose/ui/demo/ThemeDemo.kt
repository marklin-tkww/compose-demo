...
import com.example.myapplication.compose.darkThemeState
import com.example.myapplication.compose.themeTypeState
import com.example.myapplication.compose.ui.theme.ThemeType

@Composable
fun ThemePage() {
    titleLiveData.value = "Compose Theme Practice"
    ThemeContent()
}
